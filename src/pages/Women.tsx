      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6">
          <nav className="text-sm text-gray-600">
            <span>Home</span> / <span className="text-pink-600 font-medium">Women</span>
          </nav>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Curated exclusively for women - {filteredProducts.length} products</p>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm mb-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="relative">
              ...
              <Input
                placeholder="Search women's items..."
                value={searchQuery}
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No women's products found matching your criteria.</p>
            <Button 
              onClick={() => {
                setSearchQuery('');
                setPriceRange('all');
