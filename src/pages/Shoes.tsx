      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6">
          <nav className="text-sm text-gray-600">
            <span>Home</span> / <span className="text-pink-600 font-medium">Shoes</span>
          </nav>
        </div>

        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-4 bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent">
            👠 Elegant Footwear Collection
          </h1>
          <p className="text-gray-600">Step into style with our shoe collection - {filteredProducts.length} products</p>
        </div>
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No shoes found matching your criteria.</p>
            <Button 
              onClick={() => {
                setSearchQuery('');
                setPriceRange('all');
