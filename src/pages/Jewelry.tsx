      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <nav className="text-sm text-gray-600">
            <span>Home</span> / <span className="text-pink-600 font-medium">Jewelry</span>
          </nav>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Elegant necklaces, earrings & more - {filteredProducts.length} products</p>
        </div>
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No jewelry products found matching your criteria.</p>
            <Button 
              onClick={() => {
                setSearchQuery('');
                setPriceRange('all');
